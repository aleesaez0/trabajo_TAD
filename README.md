...
- José Luis Leal García
- Alejandro Sáez Cascajo
...
- Iniciar contenedores: docker-compose up -d --build

- Generar clave de aplicación: docker-compose exec app php artisan key:generate

- Ejecutar migraciones: docker-compose exec app php artisan migrate

- Ejecutar seeders para rellenar la base de datos de registros de prueba: docker-compose exec app php artisan migrate:fresh --seed
