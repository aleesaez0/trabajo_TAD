...
@section('content')
    <div class="container py-5">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <p><strong>Cliente:</strong> {{ $pedido->carro->cliente->user->name ?? '-' }}</p>
                <p><strong>Email:</strong> {{ $pedido->carro->cliente->user->email ?? '-' }}</p>
                <p><strong>Teléfono:</strong> {{ $pedido->carro->cliente->telefono ?? '-' }}</p>
                <hr>
